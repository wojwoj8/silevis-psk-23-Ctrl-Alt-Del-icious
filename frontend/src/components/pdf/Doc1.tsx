export default function Doc1(){
    ...
    <div>
        ...
        <span className="mx-10">………………………………..……. z siedzibą w ……………. ul. ………………………….,</span><br></br>
        <span className="mx-10">o nr KRS ………….…, NIP ……………………, Regon ……………………, zwanym dalej</span><br></br>
        <span className="mx-10"><b>Zakładem</b> lub <b>Zakładem Pracy</b>, reprezentowanym przez ……………………………………</span><br></br>
        <span className="mx-10">………………………………………………………………………………………………….</span><br></br>
    </div>
    <div className="mx-10 mt-10">
    <span >§ 1. Uczelnia kieruje studenta …………………………………………………………………,</span><br></br>
    <span>nr albumu ………………… do Zakładu w celu odbycia przez niego praktyki studenckiej</span><br></br>
    <span>w okresie od ……………… do ….………………</span><br></br>
